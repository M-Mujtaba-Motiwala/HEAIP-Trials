...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({ data: { id: attachment.id, fileName: attachment.fileName, mimeType: attachment.mimeType, sizeBytes: attachment.sizeBytes, url: `/uploads/chat/${storageKey}`, classification: policyResult.classification } }, { status: 201 });
