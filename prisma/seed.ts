...
const PERMISSIONS = [
  ...
  { module: "policies", resource: "policy", action: "assign", permissionKey: "policies.assign", description: "Assign policies to scopes" },
  { module: "policies", resource: "policy", action: "evaluate", permissionKey: "policies.evaluate", description: "View policy evaluation logs" },
  { module: "policies", resource: "policy", action: "export", permissionKey: "policies.export", description: "Export policies" },
  ...
  { module: "agents", resource: "agent", action: "create", permissionKey: "agents.create", description: "Create AI agents" },
  { module: "agents", resource: "agent", action: "read", permissionKey: "agents.read", description: "View AI agents" },
  { module: "agents", resource: "agent", action: "update", permissionKey: "agents.update", description: "Edit AI agents" },
  { module: "agents", resource: "agent", action: "delete", permissionKey: "agents.delete", description: "Delete AI agents" },
  { module: "workflows", resource: "workflow", action: "create", permissionKey: "workflows.create", description: "Create workflows" },
  { module: "workflows", resource: "workflow", action: "read", permissionKey: "workflows.read", description: "View workflows" },
  { module: "workflows", resource: "workflow", action: "update", permissionKey: "workflows.update", description: "Update workflows" },
  { module: "workflows", resource: "workflow", action: "delete", permissionKey: "workflows.delete", description: "Delete workflows" },
  { module: "prompts", resource: "template", action: "manage", permissionKey: "prompts.manage", description: "Manage prompt templates" },
  { module: "prompts", resource: "template", action: "read", permissionKey: "prompts.read", description: "View prompt templates" },
  { module: "knowledge", resource: "base", action: "manage", permissionKey: "knowledge.manage", description: "Manage Knowledge Bases" },
  { module: "knowledge", resource: "base", action: "read", permissionKey: "knowledge.read", description: "View Knowledge Bases" },
...
const ROLE_PERMS: Record<string, string[]> = {
  ...
  ADMIN: [
    ...
    "policies.create", "policies.read", "policies.update", "policies.assign", "policies.evaluate", "policies.export", "audit.view",
    ...
    "prompts.manage", "prompts.read", "knowledge.manage", "knowledge.read",
    "models.manage",
  ],
  DEPT_MANAGER: [
...
async function main() {
  ...
  await prisma.aiPolicy.upsert({
    ...
    create: {
      ...
      severity: "MEDIUM",
      scope: "ORGANIZATION",
      conditions: JSON.stringify({ maxRequestsPerHour: 100, maxTokensPerRequest: 5000, cooldownMinutes: 5 }),
      actions: JSON.stringify(["BLOCK_REQUEST"]),
